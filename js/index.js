...
myMod.controller('FileInspect', function ($scope, node, animation, modService, pdxDataService, pdxScriptService, $timeout, rendererService, $state, $stateParams) {
	...
	$scope.pdxShaders = [
		...
		'PdxMeshShip',
		'PdxMeshShipDiffuseEmissive',
		'PdxMeshShipDiffuseEmissiveAlpha',
		'PdxMeshShipFlow',
		'PdxMeshPortrait',
		'PdxMeshPortraitHair',
	...
	$scope.pdxShaderDescriptions = {
		'PdxMeshStandard': '[EU4 + CK2 + STLRS] The default not-transparent texture shader.',
		'Collision': '[EU4 + CK2 + STLRS] \'Shader\' which will not render the mesh, but instead use it to check for (input) collision checking. (ie the clickable space of the item)',
		'PdxMeshColor': '[EU4 + CK2 + STLRS] Shader which can blend the three \'national\' colors of the units country into the texture via the specular texture.',
		...
		'PdxMeshAlphaBlend': '[EU4 + STLRS] Shader which will allow transparency via the alpha channel of the diffuse texture.',
		...
		'PdxMeshAlphaAdditive': '[STLRS only] Shader which will allow transparency via the alpha channel of the diffuse texture.',
		'PdxMeshStar': '[STLRS only] Shader for a star.',
		'PdxMeshPlanet': '[STLRS only] Shader for a planet.',
		'PdxMeshPlanetEmissive': '[STLRS only] Shader for a planet that includes emissivity on the specular map.',
		'PdxMeshPlanetRings': '[STLRS only] Shader for a planet\'s rings which will allow transparency via the alpha channel of the diffuse texture.',
		'PdxMeshGasGiant': '[STLRS only] The not-transparent texture shader for gas giants.',
		'PdxMeshAsteroid': '[STLRS only] The not-transparent texture shader for asteroids.',
		'PdxMeshAtmosphere': '[STLRS only] Shader for a planet\'s atmosphere.',
		'PdxMeshAtmosphereStar': '[STLRS only] Shader for a star\'s atmosphere.',
		'PdxMeshClouds': '[STLRS only] Shader for a planet\'s cloud.',
		'PdxMeshTerra': '[STLRS only] Shader for a planet\'s terrain.',
		'PdxMeshTerraAlphaBlend': '[STLRS only] Shader for a planet\'s crystal-like terrain.',
		'PdxMeshShip': '[STLRS only] Shader for a spaceship.',
		'PdxMeshShipDiffuseEmissive': '[STLRS only] Shader for a spaceship.',
		'PdxMeshShipDiffuseEmissiveAlpha': '[STLRS only] Shader for a spaceship with transparency.',
		'PdxMeshShipFlow': '[STLRS only] Shader for a spaceship gas with the normal map being the flow map.',
		'PdxMeshPortrait': '[STLRS only] Shader for a species portrait.',
		'PdxMeshPortraitHair': '[STLRS only] Shader for species portrait hair.',
		'PdxMeshPortraitClothes': '[STLRS only] Shader for species portrait clothes.',
	};
